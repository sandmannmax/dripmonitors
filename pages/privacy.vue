  ...
  <div class="container mx-auto sm:p-4 p-2">
    <div>
      <h3 class="text-center text-3xl font-bold">
        Privacy Policy for lazyshoebot
      </h3>
      <p>
        At lazyshoebot, accessible from https://www.lazyshoebot.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        lazyshoebot and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in lazyshoebot. This policy is not applicable to
      ...
      <p>
        ...
        to its <router-link to="/terms">terms</router-link>.
      </p>
      ...
      <p>
        ...
        you such as your name, email address, the contents of the message and/or
      ...
      <p>
        lazyshoebot uses 'cookies'. These cookies are used to store information
      ...
      <p>
        lazyshoebot's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        lazyshoebot does not knowingly collect any Personal Identifiable
